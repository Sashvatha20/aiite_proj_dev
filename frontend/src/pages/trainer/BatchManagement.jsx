...
import { syncBatchesSheet } from '../../api/sheetsSync';
...
const statusColor = (s) =>
  s === 'ongoing' ? 'green' : s === 'upcoming' ? 'blue' : s === 'completed' ? 'orange' : 'red';
...
export default function BatchManagement() {
  ...
  const handleSyncBatchesSheet = async () => {
    try {
      ...
      toast.error(e?.response?.data?.error || 'Failed to sync batches sheet');
      console.error(e);
    } finally {
                  ...
                  <tbody>
                    {filtered.map((b) => (
                      <tr key={b.id}>
                        ...
                        <td style={S.td}>
                          <span style={S.badge(statusColor(b.status))}>{b.status}</span>
                        </td>
                        <td style={S.td}>
                          <button style={S.actBtn} onClick={() => handleEdit(b)}>
                            ✏️ Edit
                          </button>
                        </td>
                      </tr>
          ...
          <div>
            ...
            <div style={S.row2}>
              <div style={S.field}>
                ...
                <input
                  ...
                  placeholder="e.g. Jan 2026 Java Batch 1"
                />
              </div>
            ...
            <div style={S.row2}>
              <div style={S.field}>
                ...
                <input
                  ...
                  onChange={(e) => set('batch_start_date', e.target.value)}
                />
              </div>
              ...
              <div style={S.field}>
                ...
                <input
                  ...
                  onChange={(e) => set('batch_end_date', e.target.value)}
                />
              </div>
            </div>
            ...
            <div style={S.row3}>
              <div style={S.field}>
                ...
                <select
                  style={S.select}
                  value={form.weekday_weekend}
                  onChange={(e) => set('weekday_weekend', e.target.value)}
                >
